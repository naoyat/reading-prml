...
#;(define (draw-quads . vertices)
  (let ([x0 (list-ref vertices 0)]
        [y0 (list-ref vertices 1)]
        [z0 (list-ref vertices 2)]
        [x1 (list-ref vertices 3)]
        [y1 (list-ref vertices 4)]
        [z1 (list-ref vertices 5)]
        [x2 (list-ref vertices 6)]
        [y2 (list-ref vertices 7)]
        [z2 (list-ref vertices 8)]
        [x3 (list-ref vertices 9)]
        [y3 (list-ref vertices 10)]
        [z3 (list-ref vertices 11)])
